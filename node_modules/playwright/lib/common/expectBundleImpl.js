...
${d(h)}${r?"    ":""}${r?gn(e,c,String(t).length):(0,g.printReceived)(e)}`},pass:c!==-1}}let o=Array.from(e),i=o.indexOf(t);return{message:()=>{let l="Expected value",c=`Received ${(0,Et.getType)(e)}`,f=(0,g.getLabelPrinter)(l,c);return(0,g.matcherHint)(n,void 0,void 0,s)+`
...
Received string:        ${gn(e,e.indexOf(t),t.length)}`:(0,g.matcherHint)(n,void 0,void 0,r)+`
...
`+(0,g.printDiffOrStringify)(t,e,Is,Ns,sr(this.expand)),name:n,pass:s}}},Hf=Ab;var Ps=ie(Wt()),or=ie(st()),_=ie(ze());var Yi=e=>e!==!1,mn=3,tp="called with 0 arguments",Ls=e=>e.length===0?tp:e.map(t=>(0,_.printExpected)(t)).join(", "),ir=(e,t)=>e.length===0?tp:e.map((n,r)=>Array.isArray(t)&&r<t.length&&En(t[r],n)?ks(n):(0,_.printReceived)(n)).join(", "),ks=e=>(0,_.DIM_COLOR)((0,_.stringify)(e)),En=(e,t)=>(0,Ps.equals)(e,t,[...hn(),Ps.iterableEquality]),vt=(e,t)=>t.length===e.length&&En(e,t),_t=(e,t)=>t.type==="return"&&En(e,t.value),dn=e=>e.reduce((t,n)=>n.type==="return"?t+1:t,0),yn=(e,t)=>`
...
`;if(t.length===0)return o;let i="Received: ";if(r&&(s===0||s===void 0)){let a=t[0][1];if(Uf(e,a)){let l=[(0,_.EXPECTED_COLOR)("- Expected"),(0,_.RECEIVED_COLOR)("+ Received"),""],c=Math.max(e.length,a.length);for(let f=0;f<c;f+=1){if(f<e.length&&f<a.length){if(En(e[f],a[f])){l.push(`  ${ks(a[f])},`);continue}if(Zi(e[f],a[f])){let p=(0,_.diff)(e[f],a[f],{expand:n});if(typeof p=="string"&&p.includes("- Expected")&&p.includes("+ Received")){l.push(`${p.split(`
`).slice(3).join(`
...
`+t.mock.results.reduce((l,c,f)=>(c.type==="return"&&l.length<mn&&l.push(`${f+1}: ${(0,_.printReceived)(c.value)}`),l),[]).join(`
...
Received number of calls:      ${(0,_.printReceived)(t.mock.calls.length)}`:""),pass:u}},zf=e=>function(t,n){let r="expected",s={isNot:this.isNot,promise:this.promise};(0,_.ensureExpectedIsNonNegativeInteger)(n,e,s),ur(t,e,r,s);let o=vn(t),i=o?"spy":t.getMockName(),u=o?t.calls.count():t.mock.calls.length,a=u===n;return{message:a?()=>(0,_.matcherHint)(e,i,r,s)+`
...
Received number of returns: ${(0,_.printReceived)(i)}`+(t.mock.calls.length!==i?`
Received number of calls:   ${(0,_.printReceived)(t.mock.calls.length)}`:""),pass:u}},Yf=e=>function(t,...n){let r="...expected",s={isNot:this.isNot,promise:this.promise};ur(t,e,r,s);let o=vn(t),i=o?"spy":t.getMockName(),u=o?t.calls.all().map(c=>c.args):t.mock.calls,a=u.some(c=>vt(n,c));return{message:a?()=>{let c=[],f=0;for(;f<u.length&&c.length<mn;)vt(n,u[f])&&c.push([f,u[f]]),f+=1;return(0,_.matcherHint)(e,i,r,s)+`

Expected: not ${Ls(n)}
`+(u.length===1&&(0,_.stringify)(u[0])===(0,_.stringify)(n)?"":Xi(n,c,u.length===1))+`
Number of calls: ${(0,_.printReceived)(u.length)}`}:()=>{let c=[],f=0;for(;f<u.length&&c.length<mn;)c.push([f,u[f]]),f+=1;return(0,_.matcherHint)(e,i,r,s)+`

`+Ji(n,c,Yi(this.expand),u.length===1)+`
Number of calls: ${(0,_.printReceived)(u.length)}`},pass:a}},Qf=e=>function(t,n){let r="expected",s={isNot:this.isNot,promise:this.promise};ar(t,e,r,s);let o=t.getMockName(),{calls:i,results:u}=t.mock,a=u.some(c=>_t(n,c));return{message:a?()=>{let c=[],f=0;for(;f<u.length&&c.length<mn;)_t(n,u[f])&&c.push([f,u[f]]),f+=1;return(0,_.matcherHint)(e,o,r,s)+`

Expected: not ${(0,_.printExpected)(n)}
`+(u.length===1&&u[0].type==="return"&&(0,_.stringify)(u[0].value)===(0,_.stringify)(n)?"":bn("Received:     ",n,c,u.length===1))+yn(dn(u),i.length)}:()=>{let c=[],f=0;for(;f<u.length&&c.length<mn;)c.push([f,u[f]]),f+=1;return(0,_.matcherHint)(e,o,r,s)+`

Expected: ${(0,_.printExpected)(n)}
`+bn("Received: ",n,c,u.length===1)+yn(dn(u),i.length)},pass:a}},Xf=e=>function(t,...n){let r="...expected",s={isNot:this.isNot,promise:this.promise};ur(t,e,r,s);let o=vn(t),i=o?"spy":t.getMockName(),u=o?t.calls.all().map(f=>f.args):t.mock.calls,a=u.length-1,l=a>=0&&vt(n,u[a]);return{message:l?()=>{let f=[];return a>0&&f.push([a-1,u[a-1]]),f.push([a,u[a]]),(0,_.matcherHint)(e,i,r,s)+`
...
Expected: not ${(0,_.printExpected)(n)}
`+(u.length===1&&u[0].type==="return"&&(0,_.stringify)(u[0].value)===(0,_.stringify)(n)?"":bn("Received:     ",n,f,u.length===1,a))+yn(dn(u),i.length)}:()=>{let f=[];if(a>=0){if(a>0){let p=a-1;for(;p>=0&&!_t(n,u[p]);)p-=1;p<0&&(p=a-1),f.push([p,u[p]])}f.push([a,u[a]])}return(0,_.matcherHint)(e,o,r,s)+`

Expected: ${(0,_.printExpected)(n)}
`+bn("Received: ",n,f,u.length===1,a)+yn(dn(u),i.length)},pass:l}},Zf=e=>function(t,n,...r){let s="n",o={expectedColor:m=>m,isNot:this.isNot,promise:this.promise,secondArgument:"...expected"};if(ur(t,e,s,o),!Number.isSafeInteger(n)||n<1)throw new Error((0,_.matcherErrorMessage)((0,_.matcherHint)(e,void 0,s,o),`${s} must be a positive integer`,(0,_.printWithType)(s,n,_.stringify)));let i=vn(t),u=i?"spy":t.getMockName(),a=i?t.calls.all().map(m=>m.args):t.mock.calls,l=a.length,c=n-1,f=c<l&&vt(r,a[c]);return{message:f?()=>{let m=[];return c-1>=0&&m.push([c-1,a[c-1]]),m.push([c,a[c]]),c+1<l&&m.push([c+1,a[c+1]]),(0,_.matcherHint)(e,u,s,o)+`
...
${Mn}`:n.hasMessage?oe("Received message: ",n,"message")+He(n):oe("Received value:   ",n,"value")),pass:s}},j2=(e,t,n,r)=>{let s=n!==null&&r.asymmetricMatch(n.value);return{message:s?()=>(0,z.matcherHint)(e,void 0,void 0,t)+`
...
`+(n===null?Mn:n.hasMessage?oe("Received name:    ",n,"name")+oe("Received message: ",n,"message")+He(n):oe("Thrown value: ",n,"value")),pass:s}},B2=(e,t,n,r)=>{let s=Ch(r),o=n!==null?Ch(n.value):null,i=n!==null&&n.message===r.message&&o===s;return{message:i?()=>(0,z.matcherHint)(e,void 0,void 0,t)+`
...
`+Mn:n.hasMessage?(0,z.printDiffOrStringify)(s,o,`Expected ${mr(r)}`,`Received ${mr(n.value)}`,!0)+`
...
${Mn}`:`${n.value!=null&&typeof n.value.constructor=="function"?xs("Received constructor",n.value.constructor):""}
...
${Mn}`:n.hasMessage?oe("Received message:   ",n,"message")+He(n):oe("Received value:     ",n,"value")),pass:s}},U2=(e,t,n)=>{let r=n!==null;return{message:r?()=>(0,z.matcherHint)(e,void 0,"",t)+`
...
`+Mn,pass:r}},nt=(e,t)=>`${e+(0,z.printExpected)(t)}
`,oe=(e,t,n,r)=>{if(t===null)return"";if(n==="message"){let s=t.message;if(typeof r=="string"){let o=s.indexOf(r);if(o!==-1)return`${e+gn(s,o,r.length)}
